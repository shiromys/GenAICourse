    ...
    return (
        <div className="min-h-screen bg-[#020617] text-slate-200 font-sans selection:bg-amber-500/30 pt-28 pb-12">
            <div className="container mx-auto px-6 py-8">
                ...
                {/* Navigation Tabs */}
                <div className="flex flex-wrap gap-2 mb-8 bg-[#0F172A] p-2 rounded-2xl border border-slate-800 shadow-xl shadow-black/50 w-fit backdrop-blur-xl">
                    {tabs.map(tab => (
                        <button
                            key={tab.id}
                    ...
                    {activeTab === 'revenue' && (
                        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            ...
                            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                                ...
                                <div className="xl:col-span-2 bg-[#0F172A]/80 backdrop-blur-xl rounded-3xl p-8 border border-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.3)]">
                                    ...
                                    <p className="text-slate-400 mb-8 font-medium">Daily transaction volume (Last 30 Days)</p>
                                ...
                                <div className="space-y-8">
                                    <div className="bg-[#0F172A]/80 backdrop-blur-xl rounded-3xl p-8 border border-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] relative overflow-hidden">
                                        {/* Decorative flare */}
                                        <div className="absolute top-0 right-0 w-32 h-32 bg-amber-500/10 rounded-full blur-3xl -mr-10 -mt-10"></div>

                                        <h3 className="text-xl font-black text-white mb-6">Course Sales Ranking</h3>
                                                ...
                                                paymentAnalytics.revenueByCourse.map((rc, idx) => (
                                                    <div key={idx} className="flex justify-between items-center bg-slate-800/50 p-4 rounded-2xl border border-slate-700/50">
                                                        <div className="flex-1 min-w-0 pr-4">
                                                            <div className="text-sm font-bold text-slate-200 truncate">{rc.courseTitle}</div>
                                                            <div className="text-xs text-amber-500 font-mono mt-1">{rc.sales} transactions</div>
                                                        </div>
                                                        <div className="font-black text-white bg-slate-900 px-3 py-1.5 rounded-lg border border-slate-700 text-sm">
                                                            ${rc.revenue}
                                                        </div>
                                                    </div>
                                                ))
                                    ...
                                    <div className="bg-gradient-to-br from-[#1E293B] to-[#0F172A] rounded-3xl p-8 border border-slate-700 shadow-[0_8px_32px_0_rgba(0,0,0,0.3)]">
                                        <h3 className="text-xl font-black text-white mb-6">Funnel Telemetry</h3>

                                        <div className="space-y-5">
                                            <div>
                                                <div className="flex justify-between text-xs font-bold text-slate-400 mb-2 uppercase tracking-widest">
                                                    <span>Visits ➔ Checks</span>
                                                    <span className="text-emerald-400 font-mono">{paymentAnalytics?.conversionMetrics?.totalCheckoutsInitiated || 0}</span>
                                                </div>
                                            ...
                                            <div>
                                                <div className="flex justify-between text-xs font-bold text-slate-400 mb-2 uppercase tracking-widest">
                                                    ...
                                                    <span className="text-emerald-400 font-mono">{paymentAnalytics?.conversionMetrics?.checkoutConversionRate || '0%'}</span>
                                                </div>
                                                <div className="h-2 w-full bg-slate-800 rounded-full overflow-hidden">
...
const GlassStatCard = ({ title, value, icon }) => {
    return (
        <div className="relative overflow-hidden bg-[#0F172A]/80 backdrop-blur-xl rounded-3xl p-8 border border-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] transition-all duration-300 hover:-translate-y-1 hover:border-amber-500/50 group">
            ...
            <div className="relative z-10 flex items-center justify-between">
                <div>
                    <p className="text-slate-400 text-xs font-black uppercase tracking-[0.2em] mb-3">{title}</p>
                    <h3 className="text-4xl font-black text-white tracking-tighter">{value}</h3>
                </div>
                <div className="w-14 h-14 rounded-2xl bg-slate-800/80 flex items-center justify-center text-amber-500 text-2xl shadow-lg border border-slate-700/50 group-hover:scale-110 transition-transform">
                    {icon}
                </div>
            </div>
        </div>
